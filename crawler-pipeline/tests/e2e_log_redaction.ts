...
async function main() {
  ...
  logger.info("Kiểm thử JWT service role key: eyJhbGciOiJKV1Q.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c", "E2E");
