...
### Bước 2: Thiết lập Swap 4GB (Quan trọng)
Chạy script cấu hình Swap để tạo phân vùng nhớ đệm, ngăn chặn tình trạng máy chủ bị tràn RAM khi chạy các tác vụ nặng:
```bash
